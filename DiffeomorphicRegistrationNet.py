...
def create_model(config):
    ...
    vout_1 = Lambda(lambda args:vnet(args))(x_1)
    vout_2 = Lambda(lambda args:vnet(args))(x_2)
    ...
    mu_sigma_1 = Lambda(lambda args:mu_sigma_conv(args))(vout_1)
    mu_sigma_2 = Lambda(lambda args:mu_sigma_conv(args))(vout_2)
